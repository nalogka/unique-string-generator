...
class Converter
{
     ...
     */
    public static function toBinary(string $charset, string $string)
    {
     ...
     * @param string $binaryString Строка в сыром (бинарном, хранимом в слое персистентности) виде.
     ...
     */
    public static function toDecimal(string $charset, string $string)
    {
        $base = strlen($charset);
     ...
     * @return string Строка из символов исходного алфавита
     */
    public static function fromDecimal(string $charset, string $decimalStr, int $length)
    {
        $base = strlen($charset);
